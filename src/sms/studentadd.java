 ...
 */
  ...
  * when new student want to be admitted its firstly should be done
  */
public class studentadd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(667, 544, 210, -1));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 20, 40, 30));
  ...
  */
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try{
            ...
            String sql= "insert into studreg values(?,?,?,?,?,?,?,?)";
            
            PreparedStatement ptstmt= conn.prepareStatement(sql);
            ptstmt.setString(1, id.getText());
            ptstmt.setString(2, sn.getText());
            ptstmt.setString(3, gn.getText());
            ptstmt.setString(4, sc.getText());
            ptstmt.setString(5, gc.getText());
            ptstmt.setString(6, sp.getText());
            ptstmt.setString(7, cl.getText());
            ptstmt.setString(8, rl.getText());
